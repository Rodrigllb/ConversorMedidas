...
#include <windows.h> //Objetivo? Apenas mudar a cor das strings no cmd objetivando a "beleza" da interface do excutavel.

HANDLE  hConsole = GetStdHandle(STD_OUTPUT_HANDLE); //Objetivo de manipulação global de cores oe outros atributos de saída do console.
...
//Inicio do programa.
int main() {
	system("chcp 1252 > nul"); //Evitar erros de compatibilidade de caracteres especiais no cmd.
